            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse in" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a href="#" class="nav-link text-uppercase font-weight-bold"><i class="fa fa-shopping-cart"></i>@auth <span class='badge badge-warning' id='CartCount'>  {{TemplateHelper::cart()}} </span>@endauth</a></li>
